...
# Initialize a global LLM handler with 2000 rpm and the default model.
LLM_HANDLER = UnifiedLLMHandler(requests_per_minute=2000, default_model=DEFAULT_LLM_MODEL)
